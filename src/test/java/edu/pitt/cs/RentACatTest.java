...
public class RentACatTest {
	...
	public void setUp() throws Exception {
		...
		// 2. Create an unrented Cat with ID 1 and name  assign to c1
	...
	public void testCatAvailableFalseNumCats0() {
		Boolean a =r.catAvailable(2);
		
		assertFalse("return cat available is true",a);
	...
	public void testCatAvailableTrueNumCats3() {
		...
		Boolean a=r.catAvailable(2);
		assertTrue("return catavailable is false",a);
	...
	public void testCatAvailableFalseNumCats3() {
		...
		Boolean a=r.catAvailable(2);
		assertFalse("return catavailable is true",a);
	...
	public void testCatExistsFalseNumCats0() {
		Boolean a =r.catExists(2);
		
		assertFalse("return cat exist is true",a);
	}
	...
	public void testReturnCatFailureNumCats0() {
		Boolean a=r.returnCat(2);
		assertFalse("return returnCat true", a);
	}
